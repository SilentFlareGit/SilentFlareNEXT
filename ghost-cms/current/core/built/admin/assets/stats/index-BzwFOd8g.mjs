import { t as Me, D as R, J as e, S as Ae, n as h, R as D, a5 as ie, a1 as X, X as L, O as W, x as ne, z as g, B as J, i as Z, k as ee, a0 as A, A as Le } from "./index-B0-GYxa-.mjs";
import { h as T, aT as De, y as $e, H as Ee, a5 as Re, $ as le, i as F, m as S, n as H, k as I, j as B, aD as y, aC as We, ah as Fe, t as Se, _ as E, aR as oe, a9 as Y, af as He, S as q, T as ce, ac as Ie, aP as Be, R as Pe, g as Ve, Y as V, v as Oe, aZ as K, bh as Q, a7 as Ue, a0 as Ge, aE as Ye, aA as se, ae as te, aQ as Ke, I as Qe, bL as Xe, bi as qe, bT as Je, bc as $, bQ as Ze, by as O, aG as es, aF as ss, ag as ts, K as as, aH as rs, r as is } from "./stats-1OOUxAam.mjs";
import { R as ns, b as ls, P as os, a as de, T as me, D as ue, O as he, e as xe, c as cs } from "./audience-DCrfTPs2.mjs";
import { u as ds } from "./use-growth-stats-D72MhBRu.mjs";
...
const k = {
  ...
  const t = X(), [r, i] = ie(!1), { site: l, settings: m } = L(), { appSettings: c } = W(), {
    emailTrackClicks: o,
    emailTrackOpens: u,
    webAnalytics: d = !1,
  ...
  }) : null, f = "group mr-2 flex flex-col gap-1.5 hover:cursor-pointer", w = !!s?.email, C = xe({ postId: s?.id, hasEmailData: w, analytics: { webAnalytics: d, membersTrackSources: x } }), _ = C.startsWith("/editor/");
  return /* @__PURE__ */ e.jsxs(F, { className: "group/card bg-gradient-to-tr from-muted/40 to-muted/0 to-50%", "data-testid": "latest-post", children: [
    ...
    /* @__PURE__ */ e.jsxs(B, { className: "flex flex-col gap-6 px-0 lg:flex-row xl:grid xl:grid-cols-3", children: [
  ...
  const o = X(), { range: u } = L(), { appSettings: d } = W(), n = Rs().isLimited("limitAnalytics"), p = "-mb-3 h-[10vw] max-h-[200px] min-h-[100px] hover:cursor-pointer!";
  if (c)
  ...
  return /* @__PURE__ */ e.jsxs("div", { className: P, children: [
    ...
    f && /* @__PURE__ */ e.jsxs(F, { children: [
      ...
      /* @__PURE__ */ e.jsx(B, { className: "flex h-full items-center justify-center p-6", children: /* @__PURE__ */ e.jsx(
        q,
        {
  ...
  const t = X(), { range: r, settings: i } = L(), { appSettings: l } = W(), m = String(i.find((n) => n.key === "timezone")?.value || "Etc/UTC"), {
    webAnalytics: c = !1,
  ...
  return /* @__PURE__ */ e.jsxs(F, { className: "group/card w-full lg:col-span-2", "data-testid": "top-posts-card", children: [
    ...
    /* @__PURE__ */ e.jsx(B, { children: a ? /* @__PURE__ */ e.jsx(Ye, { className: "mt-6" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
  ...
  const { appSettings: s } = W(), { statsConfig: a, isLoading: t, range: r } = L(), { startDate: i, endDate: l, timezone: m } = qe(r), { isLoading: c, chartData: o, totals: u, currencySymbol: d } = ds(r), { data: x, isLoading: n } = Hs(), { data: p, isLoading: j } = Je({
    searchParams: {
      date_from: $(i),
      date_to: $(l),
      limit: "5",
...
//# sourceMappingURL=index-BzwFOd8g.mjs.map
