import { aO as d, bo as Ut, aZ as r, aj as y, bw as Bt, aA as g, bK as h, br as A, ah as K, aD as se, k as zt, aG as we, bl as $, aS as Xt, bN as re, bv as Yt, bj as j, am as Ht, X as Wt, V as Zt, K as qt, y as Jt, bk as Qt, m as en, aB as Ne, aI as tn, aL as nn, ag as on, aF as rn, w as an, az as C, ao as Ie, C as sn, bn as W, aC as cn, aK as ie } from "./index-D_R_kUw4.mjs";
import { u as dn, R as De, I as Te, a as Z, c as un } from "./index-CMF39cb6.mjs";
var q = "Tabs", [ln] = se(q, [
  Z
...
var Ae = "TabsTrigger", Re = d(
  (e, n) => {
    const { __scopeTabs: t, value: o, disabled: a = !1, ...s } = e, c = ce(Ae, t), u = Se(t), m = Fe(c.baseId, o), v = Le(c.baseId, o), l = o === c.value;
    return /* @__PURE__ */ r.jsx(
      Te,
      {
        asChild: !0,
...
var ke = "TabsContent", Oe = d(
  (e, n) => {
    const { __scopeTabs: t, value: o, forceMount: a, children: s, ...c } = e, u = ce(ke, t), m = Fe(u.baseId, o), v = Le(u.baseId, o), l = o === u.value, i = h(l);
    return A(() => {
      const f = requestAnimationFrame(() => i.current = !1);
      return () => cancelAnimationFrame(f);
    }, []), /* @__PURE__ */ r.jsx(K, { present: a || l, children: ({ present: f }) => /* @__PURE__ */ r.jsx(
      y.div,
      {
        "data-state": l ? "active" : "inactive",
...
var _ = "MenuContent", [_n, fe] = I(_), Ye = d(
  ...
  (e, n) => {
    const {
      ...
      ...T
    } = e, R = D(_, t), S = V(_, t), kt = ue(t), Ot = Be(t), he = xn(t), [Ft, be] = re(null), B = h(null), Lt = $(n, B, R.onContentChange), z = h(0), X = h(""), Gt = h(0), ee = h(null), Me = h("right"), te = h(0), Kt = x ? Ht : Wt, $t = x ? { as: wn, allowPinchZoom: !0 } : void 0, Vt = (p) => {
      const E = X.current + p, N = he().filter((M) => !M.disabled), k = document.activeElement, ne = N.find((M) => M.ref.current === k)?.textValue, oe = N.map((M) => M.textValue), _e = On(oe, E, ne), O = N.find((M) => M.textValue === _e)?.ref.current;
      (function M(Ce) {
                    ...
                    children: /* @__PURE__ */ r.jsx(
                      Jt,
                      {
                        ...
                        onKeyDown: g(T.onKeyDown, (p) => {
                          ...
                          const oe = B.current;
                          if (p.target !== oe || !mn.includes(p.key)) return;
                          p.preventDefault();
...
var Y = "MenuItem", ye = "menu.itemSelect", Q = d(
  (e, n) => {
    const { disabled: t = !1, onSelect: o, ...a } = e, s = h(null), c = V(Y, e.__scopeMenu), u = fe(Y, e.__scopeMenu), m = $(n, s), v = h(!1), l = () => {
      const i = s.current;
      if (!t && i) {
        const f = new CustomEvent(ye, { bubbles: !0, cancelable: !0 });
        i.addEventListener(ye, (w) => o?.(w), { once: !0 }), nn(i, f), f.defaultPrevented ? v.current = !1 : c.onClose();
      }
    };
    return /* @__PURE__ */ r.jsx(
      We,
      {
        ...
        onKeyDown: g(e.onKeyDown, (i) => {
          ...
          t || f && i.key === " " || ae.includes(i.key) && (i.currentTarget.click(), i.preventDefault());
        })
      }
    );
  }
...
var We = d(
  (e, n) => {
    const { __scopeMenu: t, disabled: o = !1, textValue: a, ...s } = e, c = fe(Y, t), u = Be(t), m = h(null), v = $(n, m), [l, i] = re(!1), [f, w] = re("");
    return A(() => {
      const x = m.current;
...
var An = "MenuSub", [$o, at] = I(An), F = "MenuSubTrigger", st = d(
  (e, n) => {
    const t = D(F, e.__scopeMenu), o = V(F, e.__scopeMenu), a = at(F, e.__scopeMenu), s = fe(F, e.__scopeMenu), c = h(null), { pointerGraceTimerRef: u, onPointerGraceIntentChange: m } = s, v = { __scopeMenu: e.__scopeMenu }, l = j(() => {
    ...
    }, [u, m]), /* @__PURE__ */ r.jsx(le, { asChild: !0, ...v, children: /* @__PURE__ */ r.jsx(
      We,
      {
        id: a.triggerId,
        "aria-haspopup": "menu",
        ...
        onPointerLeave: g(
          ...
          G((i) => {
            ...
            if (f) {
              const w = t.content?.dataset.side, x = w === "right", T = x ? -5 : 5, R = f[x ? "left" : "right"], S = f[x ? "right" : "left"];
        ...
        onKeyDown: g(e.onKeyDown, (i) => {
          ...
          e.disabled || f && i.key === " " || vn[o.dir].includes(i.key) && (t.onOpenChange(!0), t.content?.focus(), i.preventDefault());
        })
      }
    ) });
  }
...
var it = "MenuSubContent", ct = d(
  (e, n) => {
    const t = ze(_, e.__scopeMenu), { forceMount: o = t.forceMount, ...a } = e, s = D(_, e.__scopeMenu), c = V(_, e.__scopeMenu), u = at(it, e.__scopeMenu), m = h(null), v = $(n, m);
    return /* @__PURE__ */ r.jsx(L.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ r.jsx(K, { present: o || s.open, children: /* @__PURE__ */ r.jsx(L.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ r.jsx(
      me,
      {
        id: u.contentId,
        ...
        trapFocus: !1,
        onOpenAutoFocus: (l) => {
          c.isUsingKeyboardRef.current && m.current?.focus(), l.preventDefault();
        },
        ...
        onKeyDown: g(e.onKeyDown, (l) => {
          const i = l.currentTarget.contains(l.target), f = gn[c.dir].includes(l.key);
          i && f && (s.onOpenChange(!1), u.trigger?.focus(), l.preventDefault());
        })
      }
    ) }) }) });
  }
...
function Fn(e, n) {
  ...
  for (let s = 0, c = n.length - 1; s < n.length; c = s++) {
    const u = n[s], m = n[c], v = u.x, l = u.y, i = m.x, f = m.y;
    l > o != f > o && t < (i - v) * (o - l) / (f - l) + v && (a = !a);
  }
  return a;
}
function Ln(e, n) {
    ...
    return /* @__PURE__ */ r.jsx(
      $n,
      {
        ...
        onInteractOutside: g(e.onInteractOutside, (u) => {
          const m = u.detail.originalEvent, v = m.button === 0 && m.ctrlKey === !0, l = m.button === 2 || v;
...
//# sourceMappingURL=tabs-euqE78Xf.mjs.map
