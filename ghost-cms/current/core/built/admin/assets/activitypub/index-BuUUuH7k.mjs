import { aF as ce, bb as X, bK as y, br as C, bC as S, aZ as e, a9 as z, aa as V, av as Me, aQ as Be, al as De, ak as Pe, a as Te, A as de, t as p, W as xe, aR as Fe, a6 as Z, a1 as Ie, S as ue, bN as v, bj as Oe, b as me, j as Ae, e as he, h as q, i as W, f as G, a0 as J, au as Re, Y as $e, g as K, d as fe, b7 as B, ac as Ee, af as He, ae as Le, ad as oe, c as Se, ay as ze, bH as pe, bA as Ve, bD as _e, bB as Qe, bf as Ye, bS as qe, be as We, bR as Ge, a4 as re, N as Je, M as Ke, ar as R, L as Xe, D as Ze, J as es, E as ss, H as ls, I as ns, _ as as, C as os, q as rs, b5 as te, b1 as ts, b6 as is, ax as Q, r as cs, aV as ds, O as xs, bI as us, ba as be, bJ as ms } from "./index-D_R_kUw4.mjs";
import { S as je } from "./separator-0VjF6uuC.mjs";
import { E as hs } from "./edit-profile-wPgHtrKN.mjs";
import { T as fs, b as ps, c as H, d as Y, a as L } from "./tabs-euqE78Xf.mjs";
import { S as bs } from "./settings-C5Uxi5Ax.mjs";
import { C as js } from "./copy-DatiJ4K3.mjs";
const gs = [
  [
    "path",
    {
...
const ge = ({
  ...
  return /* @__PURE__ */ e.jsxs("div", { className: "pt-3", "data-testid": "actor-list", children: [
    u === !1 && r.length === 0 ? /* @__PURE__ */ e.jsxs(z, { children: [
      ...
      const k = l.handle || Be(l), N = k === o?.handle;
  ...
  const o = pe(), a = Ve(), t = S(), { canGoBack: x } = _e(), l = o.handle ? `/profile/${o.handle}` : "/profile", h = !o.handle, b = o.handle ? o.tab || "" : a.pathname.split("/").pop() || "", g = Qe(() => h ? ["likes", "following", "followers"] : ["following", "followers"], [h]), k = g.includes(b) ? b : "posts", N = Ye("index"), D = qe("index"), F = We("index"), m = Ge("index"), $ = X("index", "me"), { data: E } = o.handle ? $ : { data: void 0 }, I = o.handle === E?.handle || !o.handle, P = s?.blockedByMe, T = s?.domainBlockedByMe, [f, U] = v(!1), [O, j] = v(!1), M = y(null);
  C(() => () => {
...
//# sourceMappingURL=index-BuUUuH7k.mjs.map
