import { aF as y, bK as g, aZ as e, t as b, a6 as j, bM as v, a$ as p, bU as w, bN as R, aQ as N, A as T, a8 as M } from "./index-D_R_kUw4.mjs";
const C = [
...
function z(t, l = {}) {
  const { includeAncestors: d = !1 } = l, { data: a, isLoading: c, loadMoreChildren: n, loadMoreChildReplies: i, hasMoreChildren: r, hasMoreChildReplies: s } = v("index", t), o = d ? a?.ancestors?.chain?.map(p) || [] : [], h = a?.post ? p(a.post) : void 0, m = (a?.children ?? []).map((u) => {
...
//# sourceMappingURL=deleted-feed-item-CON4rYA1.mjs.map
