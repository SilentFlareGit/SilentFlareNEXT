import { bH as G, bD as ee, bN as m, bK as C, bC as te, br as $, aZ as e, a4 as y, ar as i, N as se, M as ae, ak as ne, A as oe, aQ as le, b3 as ce, aR as ie, S as j, al as re, aW as R, a6 as de } from "./index-D_R_kUw4.mjs";
import { u as xe, D as ue, A as he, S as U } from "./deleted-feed-item-CON4rYA1.mjs";
import { H as me } from "./hash-WKLep8p5.mjs";
const p = () => /* @__PURE__ */ e.jsx("div", { className: "h-px w-full bg-gray-200 dark:bg-gray-950" }), pe = () => {
  const { postId: z } = G(), { canGoBack: k } = ee(), [B, H] = m(/* @__PURE__ */ new Set()), [T, I] = m(/* @__PURE__ */ new Set()), [S, P] = m(/* @__PURE__ */ new Set()), [w, D] = m(!1), V = C(null), b = C(null), r = C(null), v = C(null), h = te(), {
    threadParents: d,
    post: a,
    processedReplies: M,
    isLoading: W,
  ...
  return /* @__PURE__ */ e.jsx(y, { children: /* @__PURE__ */ e.jsx("div", { className: "mx-auto flex h-full max-w-[620px] flex-col", children: /* @__PURE__ */ e.jsx("div", { className: "relative flex-1", children: /* @__PURE__ */ e.jsx("div", { className: "grow overflow-y-auto", children: /* @__PURE__ */ e.jsxs("div", { className: "mx-auto px-8 pt-5 pb-10 max-lg:px-0", children: [
    ...
    /* @__PURE__ */ e.jsx("div", { ref: b, className: `${k ? "scroll-mt-[12px]" : "scroll-mt-[124px]"}`, children: /* @__PURE__ */ e.jsxs("div", { className: `${d.length > 0 && "min-h-[calc(100vh-52px)]"}`, children: [
      ...
      /* @__PURE__ */ e.jsxs("div", { ref: V, children: [
        M.map((t, o) => {
          const s = o === M.length - 1, l = t.mainReply.id, x = B.has(l), Z = T.has(l), J = S.has(l), u = t.chain.length > 0;
...
//# sourceMappingURL=note-DnGKebGH.mjs.map
