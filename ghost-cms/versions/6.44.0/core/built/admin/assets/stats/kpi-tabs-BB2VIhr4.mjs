import { D as c, J as a, a3 as B, W, T as f, n as v, p as q, v as y } from "./index-B0-GYxa-.mjs";
import { bE as H, bD as J, am as x, bG as O, ap as Q, a1 as U, a_ as T, b3 as C, b1 as X, al as Y, Q as Z, ac as tt, h as et, aP as at, a7 as nt } from "./stats-1OOUxAam.mjs";
var h = "Tabs", [st] = X(h, [
  C
]), w = C(), [ot, N] = st(h), I = c(
  (t, e) => {
...
K.displayName = k;
var D = "TabsContent", A = c(
  (t, e) => {
    const { __scopeTabs: s, value: n, forceMount: o, children: i, ...r } = t, l = N(D, s), b = M(l.baseId, n), g = P(l.baseId, n), d = n === l.value, u = B(d);
    return W(() => {
...
var E = I, R = V, j = K, S = A;
const m = q("segmented"), F = c(({ variant: t = "segmented", ...e }, s) => /* @__PURE__ */ a.jsx(m.Provider, { value: t, children: /* @__PURE__ */ a.jsx(E, { ref: s, ...e }) }));
...
const rt = y(
  ...
  return /* @__PURE__ */ a.jsx(
    ...
    {
      ref: s,
      className: v(rt({ variant: n, className: t })),
      ...e
    }
  );
});
...
const $ = y(
  ...
  return /* @__PURE__ */ a.jsx(
    ...
    {
      ref: s,
      className: v($({ variant: n, className: t })),
      ...e
    }
  );
});
...
const it = y(
  ...
  return /* @__PURE__ */ a.jsx(
    ...
    {
      ref: s,
      className: v(it({ variant: n, className: t })),
      ...e
    }
  );
});
...
const dt = c(({
  ...
  return /* @__PURE__ */ a.jsxs("div", { className: "relative rounded-md hover:bg-muted", children: [
    /* @__PURE__ */ a.jsx(
      ...
      {
        ref: n,
        className: v($({ variant: o, className: e })),
        ...s,
...
const vt = ({ children: t, ...e }) => /* @__PURE__ */ a.jsx(G, { className: "h-auto", ...e, children: t }), mt = ({
  color: t,
  icon: e,
  label: s,
  value: n,
...
//# sourceMappingURL=kpi-tabs-BB2VIhr4.mjs.map
