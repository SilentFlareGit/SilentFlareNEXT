import { a5 as U, X as $, a1 as ae, a4 as se, O as F, a0 as m, z as D, W as re, J as e, B as S, x as ne, r as xe, N as ge, R as J } from "./index-B0-GYxa-.mjs";
import { bz as fe, g as te, N as be, Q as je, O as ve, P as Y, Y as ke, s as we, o as Ne, aU as ye, aV as Se, aY as _e, w as Ce, ao as Te, B as De, S as le, a8 as ie, bh as X, at as Re, ay as Le, aa as Oe, az as Me, au as Pe, av as Be, ax as Ee, aw as Ae, bi as q, bc as W, bO as ze, bJ as Ke, bK as Ve, aG as He, aF as We, ag as $e, K as Fe, aH as Ge, i as ce, j as oe, m as Ie, n as Ye, k as Qe, aE as Ue, h as Je } from "./stats-1OOUxAam.mjs";
import { T as Xe, c as qe, a as Q, b as P, K as Ze } from "./kpi-tabs-BB2VIhr4.mjs";
import { B as et, T as tt, a as at, e as st, f as H, d as E, S as V, b as L } from "./sort-button-DA_nsVfw.mjs";
const rt = ({ active: s, payload: t }) => {
  ...
  const [l, h] = U(i), [p, v] = U(!1), { range: u } = $(), w = ae(), [b] = se(), { appSettings: N } = F(), { emailTrackClicks: j, emailTrackOpens: y } = N?.analytics || {}, { totalSubscribers: O, avgOpenRate: d, avgClickRate: o } = r, f = m(() => {
    if (!s || s.length === 0)
      return [];
    let c = [];
  ...
  }), []), { barDomain: T, barTicks: M } = m(() => {
    if (!t || t.length === 0 || l === "total-subscribers")
      return { barDomain: [0, 1], barTicks: [0, 1] };
    const c = g[l]?.datakey;
    if (!c)
      return { barDomain: [0, 1], barTicks: [0, 1] };
    const k = t.map((I) => I[c]).filter((I) => typeof I == "number");
    if (k.length === 0)
      return { barDomain: [0, 1], barTicks: [0, 1] };
    const R = Math.min(...k), B = Math.max(...k), A = Math.floor(R * 10) / 10, z = Math.ceil(B * 10) / 10, K = Math.max(0, A), ee = z === K ? K + 0.1 : z;
    return {
      barDomain: [K, ee],
      barTicks: [K, ee]
    };
  ...
  let G = "grid-cols-3";
  (!j || !y) && (G = "grid-cols-2"), !j && !y && (G = "grid-cols-1");
  ...
  return /* @__PURE__ */ e.jsxs(Xe, { defaultValue: i, variant: "kpis", children: [
    /* @__PURE__ */ e.jsxs(qe, { className: `-mx-6 hidden grid-cols-3 md:visible! md:grid! ${G}`, children: [
    ...
    Re,
    {
      ...
      children: [
        /* @__PURE__ */ e.jsxs(Le, { className: "w-auto", children: [
          ...
          /* @__PURE__ */ e.jsx(Me, { placeholder: "Select a newsletter" })
        ] }),
  ...
  }, [l, h, i, r]), v = Ke({ searchParams: p, enabled: n });
  return n ? v : {
    data: void 0,
    isLoading: !1,
    error: null,
  ...
  }, [s, t]), a = Ve({ searchParams: n, enabled: r });
  return r ? a : {
    data: void 0,
    isLoading: !1,
    error: null,
  ...
  const a = ae(), { settings: i } = $(), l = String(i.find((d) => d.key === "timezone")?.value || "Etc/UTC"), { data: h, isLoading: p, isClicksLoading: v } = de(
    ...
    t || void 0,
    !!r
  ), { appSettings: u } = F(), { emailTrackClicks: w, emailTrackOpens: b } = u?.analytics || {}, N = m(() => h?.stats || [], [h]), j = b && w ? 5 : b || w ? 4 : 3, y = m(() => /* @__PURE__ */ e.jsx(e.Fragment, { children: /* @__PURE__ */ e.jsx(H, { className: "last:border-none [&>td]:py-2.5", children: /* @__PURE__ */ e.jsx(L, { className: "font-medium", colSpan: j, children: /* @__PURE__ */ e.jsx(Ue, { className: "mt-5" }) }) }) }), [j]), O = m(() => N.length > 0 ? /* @__PURE__ */ e.jsx(e.Fragment, { children: N.map((d) => /* @__PURE__ */ e.jsxs(H, { className: "last:border-none [&>td]:py-2.5", children: [
  ...
  ] }, d.post_id)) }) : /* @__PURE__ */ e.jsx(H, { className: "border-none hover:bg-transparent", children: /* @__PURE__ */ e.jsx(L, { className: "text-center group-hover:bg-transparent!", colSpan: j, children: /* @__PURE__ */ e.jsx(
    le,
    {
      className: "size-full py-20",
...
const me = J.memo(({ sortBy: s, setSortBy: t, range: r }) => {
  const n = m(() => /* @__PURE__ */ e.jsxs(Ie, { children: [
  ...
  return /* @__PURE__ */ e.jsx(st, { children: /* @__PURE__ */ e.jsxs(H, { children: [
    /* @__PURE__ */ e.jsx(E, { className: "min-w-[320px]", variant: "cardhead", children: n }),
    /* @__PURE__ */ e.jsx(E, { className: "w-[65px]", children: /* @__PURE__ */ e.jsx(V, { activeSortBy: s, setSortBy: t, sortBy: "date desc", children: "Date" }) }),
    /* @__PURE__ */ e.jsx(E, { className: "w-[90px] text-right", children: /* @__PURE__ */ e.jsx(V, { activeSortBy: s, setSortBy: t, sortBy: "sent_to desc", children: "Sent" }) }),
    l && /* @__PURE__ */ e.jsx(E, { className: "w-[90px] text-right", children: /* @__PURE__ */ e.jsx(V, { activeSortBy: s, setSortBy: t, sortBy: "open_rate desc", children: "Opens" }) }),
    i && /* @__PURE__ */ e.jsx(E, { className: "w-[90px] text-right", children: /* @__PURE__ */ e.jsx(V, { activeSortBy: s, setSortBy: t, sortBy: "click_rate desc", children: "Clicks" }) })
  ] }) });
});
...
const gt = () => {
  const { range: s, selectedNewsletterId: t } = $(), [r] = se(), { appSettings: n } = F(), a = r.get("tab") || "total-subscribers", { data: i, isLoading: l } = ct({
    ...
    if (u?.stats && u.stats.length > 0) {
      const x = u.stats, C = x.reduce((T, M) => T + (M.open_rate || 0), 0), g = x.reduce((T, M) => T + (M.click_rate || 0), 0);
  ...
  return n && !n.newslettersEnabled ? /* @__PURE__ */ e.jsx(ge, { to: "/analytics" }) : /* @__PURE__ */ e.jsxs(He, { children: [
    /* @__PURE__ */ e.jsx(We, { children: /* @__PURE__ */ e.jsxs($e, { children: [
      /* @__PURE__ */ e.jsx(lt, { newsletters: i?.newsletters }),
      /* @__PURE__ */ e.jsx(Fe, {})
    ] }) }),
    /* @__PURE__ */ e.jsx(Ge, { isLoading: !1, loadingComponent: /* @__PURE__ */ e.jsx(e.Fragment, {}), children: /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
...
//# sourceMappingURL=index-BfrNH7UQ.mjs.map
