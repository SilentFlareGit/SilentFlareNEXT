import { b as p1, $ as Q, V as D1, K as n1, N as s1, a2 as V1, q as R1, d as Q1, Z as i1, J as I1, W as P, H as l1, G as E1, E as F1, B as Z1, _ as X1, a7 as f1, k as v1, a9 as B, ai as $, am as k1, a6 as T, Y as C1, X as U1, l as e, h as w1, Q as L, T as G1, F as N1, aa as e1, ao as q1, e as K1, f as Y1, af as _1 } from "./index-BuIZkUhD.mjs";
class b1 extends p1 {
  constructor(o, r) {
  ...
  createResult(o, r) {
    ...
    const z = k === "fetching", C = v === "loading", y = v === "error";
    return {
      status: v,
      fetchStatus: k,
      isLoading: C,
...
let te = class extends p1 {
  ...
  updateResult() {
    const o = this.currentMutation ? this.currentMutation.state : Z1(), r = o.status === "loading", n = {
      ...o,
      isLoading: r,
      isPending: r,
...
`) || [];
  ...
  return async (r, {
    ...
    let g = 0, p = 0;
    const w = Date.now(), k = 15e3, v = [500, 1e3], V = [Y, H1, TypeError], R = (C, y) => {
      const S = {
        errorName: C?.name,
        attempts: g,
        totalSeconds: p / 1e3,
      ...
      for (; g === 0 || c; )
        try {
          ...
          if (g !== 0 && o && Y1("Request failed after multiple attempts", { extra: R() }), C && typeof C == "object" && "name" in C && C.name === "AbortError")
            throw new Mr();
          let y = C;
          throw C instanceof m || (y = new Y({ cause: C })), y;
        }
    } finally {
      clearTimeout(z);
    }
...
//# sourceMappingURL=hooks-D4pJ_p_P.mjs.map
