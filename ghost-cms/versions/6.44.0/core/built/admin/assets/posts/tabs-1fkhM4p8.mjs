import { x as l, Q as r, ak as G, a9 as L, a7 as m, i as p, k as z, n as y } from "./index-BuIZkUhD.mjs";
import { t as K, c as x, w as B, i as T, l as q, b as H } from "./button-CQCNdxY6.mjs";
import { F as O, r as Q, I as J, E as j, n as U } from "./skeleton-DrFcKwP3.mjs";
var h = "Tabs", [W] = q(h, [
  j
]), I = j(), [X, N] = W(h), _ = l(
  (t, a) => {
...
var w = "TabsList", V = l(
  (t, a) => {
    const { __scopeTabs: n, loop: e = !0, ...s } = t, d = N(w, n), o = I(n);
    return /* @__PURE__ */ r.jsx(
      Q,
      {
        asChild: !0,
...
//# sourceMappingURL=tabs-1fkhM4p8.mjs.map
