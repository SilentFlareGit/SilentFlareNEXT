import { Q as o, x as l, ak as u, a9 as z, S as H, i as n } from "./index-BuIZkUhD.mjs";
import { s as A, i as L, p as G, l as W, h as D } from "./button-CQCNdxY6.mjs";
import { R as V, j as v, P as Y, W as q, a as B, T as Q, D as J, C as f, O as K, i as U } from "./dialog-DRN6olky.mjs";
...
C.displayName = j;
var h = "AlertDialogDescription", E = l((e, a) => {
  const { __scopeAlertDialog: t, ...s } = e, r = i(t);
  return /* @__PURE__ */ o.jsx(J, { ...r, ...s, ref: a });
});
E.displayName = h;
var le = "AlertDialogAction", P = l(
  (e, a) => {
    const { __scopeAlertDialog: t, ...s } = e, r = i(t);
    return /* @__PURE__ */ o.jsx(f, { ...r, ...s, ref: a });
  }
);
P.displayName = le;
var S = "AlertDialogCancel", T = l(
  (e, a) => {
    ...
    return /* @__PURE__ */ o.jsx(f, { ...g, ...s, ref: p });
  }
);
T.displayName = S;
var ie = ({ contentRef: e }) => {
...
}, ne = N, ce = y, O = _, R = b, $ = P, w = T, M = C, I = E;
const ye = ne, de = ce, k = l(({ className: e, ...a }, t) => /* @__PURE__ */ o.jsx(
  O,
  {
    className: n(
...
//# sourceMappingURL=alert-dialog-mmQvJUHQ.mjs.map
