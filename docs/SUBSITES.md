...
| `api.silentflare.com` | Custom business API | Placeholder for a future API service |
| `admin.silentflare.com` | SilentFlare custom admin | Placeholder for a future dashboard |
...
http://localhost:4321/admin/  -> admin placeholder page
...
SilentFlare-owned services should own users, comments, likes, bookmarks, analytics, automations, AI features, and any custom business data.
